...
if (isset($_POST['action'])) {
    ...
    if ($_POST['action'] === 'clear_after_order') {
        $_SESSION['cafe_bag'] = [];
...
<body>
    ...
    <section class="page-banner">
        <div class="container text-white">
            <div class="display-6 fw-bold mb-1">Your Selected Delights</div>
        ...
        <?php if (!$is_logged_in): ?>
            <div class="row justify-content-center">
                <div class="col-md-6 text-center py-5 bag-container-card p-5">
                    ...
                    <div class="fw-bold text-dark">Access Denied</div>
    ...
    <?php if ($is_logged_in): ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 border-0 shadow">
                    <div class="modal-body text-center p-5">
                        <div class="mb-4"><i class="bi bi-trash3 text-danger display-1"></i></div>
                        <div class="fw-bold">Empty Your Bag?</div>
        ...
        <div class="modal fade" id="emptyCartModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 border-0 shadow">
                    <div class="modal-body text-center p-5">
                        <div class="mb-4"><i class="bi bi-bag-x display-1 text-danger"></i></div>
                        <div class="fw-bold">Your Bag is Empty!</div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', async () => {
                ...
                const postData = async (formData) => {
                    try {
                        const res = await fetch('bag.php', { method: 'POST', body: formData });
                ...
                window.alterQty = async (id, amount) => {
                    ...
                    if (data && data.status === 'success') renderBag(data.cart);
                };
                ...
                document.getElementById('btnConfirmClearBag').addEventListener('click', async () => {
                    ...
                    if (data && data.status === 'success') {
                        renderBag(data.cart);
                        if (clearBagModalInstance) clearBagModalInstance.hide();
                    }
                });

                document.getElementById('btnPlaceOrder').addEventListener('click', () => {
                    if (globalCart.length === 0) {
                        new bootstrap.Modal(document.getElementById('emptyCartModal')).show();
                        return;
                    }
