    ...
    if (!empty($cart_items)) {
        ...
        try {
            ...
            try {
                ...
                // Skip if payment table isn't ready yet
            }
            ...
            if (!empty($cat_id) && $order_type === 'Pre-order') {
                ...
                $cat_stmt = $conn->prepare("
                    INSERT INTO catbooking_tbl (customer_id, cat_id, areabooking_id, booking_date, booking_time, booking_status) 
                    VALUES (?, ?, ?, ?, ?, ?)
                ");
                $cat_stmt->bind_param("iiisss", $user_id, $cat_id, $areabooking_id, $booking_date, $booking_time, $booking_status);
                $cat_stmt->execute();
                $cat_stmt->close();
            }
...
<head>
    ...
    <style>
        body { font-family: 'Poppins', sans-serif; background-color: #fcfbfa; padding-top: 80px; }
...
<body>
    ...
    <div class="container py-5">
        <div class="text-center mb-5">
            <div style="font-family: 'Playfair Display', serif;" class="fw-bold text-dark">Review Your Order</div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="card summary-card p-4 h-100">
                    <div style="font-family:'Playfair Display',serif;" class="fw-bold text-dark mb-4">
                ...
                <div class="card summary-card p-4">
                    ...
                    <div class="border-top pt-3 mt-3">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div class="fw-bold text-dark mb-0" id="viewGrandTotal">₱0.00</div>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        currentBag.forEach(item => {
            ...
            itemsContainer.innerHTML += `
                <div class="d-flex justify-content-between align-items-center item-row">
                    <div>
                        <div class="mb-0 fw-bold text-dark small">${item.name}</div>
        ...
        document.getElementById('viewGrandTotal').innerText = '₱' + currentCartTotal.toLocaleString('en-US', { minimumFractionDigits: 2 });
    ...
    function renderPayPalButton() {
        ...
        paypal.Buttons({
            createOrder: (data, actions) => actions.order.create({
                purchase_units: [{ amount: { currency_code: 'PHP', value: currentCartTotal.toFixed(2) } }]
            }),
            onApprove: (data, actions) => actions.order.capture().then(() => {
                document.getElementById('dbPaymentMethod').value = 'PayPal';
                document.getElementById('finalOrderForm').submit();
            }),
            onError:  (err) => { console.error(err); alert('Something went wrong with PayPal. Please try again.'); },
            onCancel: ()    => { alert('Payment cancelled. Your order has not been placed.'); }
